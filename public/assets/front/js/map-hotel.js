    ...
    featured_content.forEach(function (element) {
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          a.bindPopup('<div class="product-default p-0"> <figure class="product-img"> <a href="hotel/' + element.slug + '/' + element.id + '" class="lazy-container ratio ratio-5-3"> <img class="lazyload" src="assets/img/hotel/logo/' + element.logo + '" data-src="assets/img/hotel/logo/' + element.logo + '" alt="Product"> </a></figure><div class="product-details"><h6 class="product-title"><a href="hotel/' + element.slug + '/' + element.id + '">' + element.title + '</a></h6><span class="product-location icon-start"><i class="fal fa-map-marker-alt"></i>' + address + '</span></div></div>', jpopup_customOptions);
        },
