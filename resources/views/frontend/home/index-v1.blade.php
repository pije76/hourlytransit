...
@section('content')
  ...
  <section class="hero-banner hero-banner_v1 header-next">
      ...
      <div class="row align-items-center">
        <div class="col-lg-7">
          <div class="fluid-left">
            <div class="banner-content mb-30">
              ...
              <p class="text">
                {{ !empty($sectionContent->hero_section_subtitle) ? $sectionContent->hero_section_subtitle : '' }}</p>
            </div>
            ...
            <div class="scroll-down mb-40">
              <a href="#scrollDiv" class="btn-icon-text" title="{{ __('Btn') }}" target="_self">
        ...
        <div class="col-lg-5">
          <div class="banner-img mb-40">
            <img class="lazyload" data-src="{{ asset('assets/img/homepage/' . $images->hero_section_image) }}"
              alt="Image">
          </div>
        </div>
      </div>
    ...
    <!-- Bg shape -->
    <div class="bg-shape">
      <img class="lazyload" data-src="{{ asset('assets/img/shape/bg-shape-1.png') }}" alt="Image">
    </div>
  </section>
  <!-- Hero section end -->
              ...
              <div class="info-list mt-30">
                @foreach ($features as $feature)
                  <div class="card mb-20">
                    ...
                    <div class="card_content">
                      <span class="h3 lh-1 mb-1 fw-normal">{{ $feature->title }}</span>
